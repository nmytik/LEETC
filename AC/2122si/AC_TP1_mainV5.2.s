...
;  c) Cada instrução do P16 ocupa 16 bits. A função, implementada da maneira que está, usa 10 instruções, ou seja, 160 bits * 2, 320bits. São 40 bytes ocupados.
; 
; 2.
...
;     return uc;
; }
;   Registos: r0 = c = uc // r1 = 'a' // r2 = 'z' // r3 = ('a' - 'A')
to_upper:
    mov r1, CHAR_a              ; r1 = 'a'
    mov r2, CHAR_z              ; r2 = 'z'
