...
function_average:
    ...
    if_function_average:
        ...
        if_neg_function_average:
            ...
            mvn r2, r2                        ; Faz o complementar do resultado da média, uma vez que o return do summation era negativo, a média também será
...
function_summation:
    ...
    for_function_summation:
        ...
        asr r5, r5, #8                                  ; Move os 8 bits agora na esquerda, de volta para a direita mas mantendo o sinal (bit 15 mantém o valor/sinal)
...
array_1:
    .byte   24, 25, 29, 34, 38, 40, 41, 41, 39, 35, 30, 26      ; Soma  = 402 => 402(N), Média = 33.5 => 33

array_2:
    .byte   -25, -22, -17, -5, 5, 11, 12, 9, 3, -7, -19, -24    ; Soma  = -79 => 65457 (N), Média = -6.58(3) => 65530 (16b) => 250(8b)
